...
VERBINDLICHE DESIGNHALTUNG

- Setze die Website als ruhige, hochwertige digitale Unternehmens-Visitenkarte
  um und nicht als aggressive Vertriebs-Landingpage oder digitalen Flyer.
- Entferne unnötige Banner, Stichwortstreifen, dekorative Rechtecke, Badge-Wolken,
  Trust-Bars und Karten ohne klare inhaltliche Funktion.
- Nutze Weißraum, Typografie, wenige passende Bilder und höchstens wenige gezielte
  Markenfarbakzente statt vieler farbiger Flächen.
- Übernimm vorhandene Markenfarben verbindlich. Neutrale Hintergründe und
  Sekundärfarben müssen damit harmonieren; erfinde keine konkurrierende Akzentfarbe.
- Stelle sicher, dass Logo und enthaltener Schriftzug einen deutlichen Kontrast zum
  Hintergrund haben. Verfärbe das Logo nicht, sondern passe die Hintergrundfläche an.
- Verwende im Hero bevorzugt ein branchenspezifisches Motiv mit Materialien,
  Produkten, Werkzeugen, Oberflächen oder typischen Arbeitsdetails.
- Im Hero nur einen primären CTA-Button. Eine zweite Aktion nur bei einem anderen
  notwendigen Ziel und dann als zurückhaltender Textlink. Den primären CTA höchstens
  einmal im abschließenden Kontaktbereich wiederholen.
- Verwende genau eine aussagekräftige H1 und danach eine logisch aufgebaute,
  SEO-sinnvolle H2-H3-Struktur ohne übersprungene Ebenen und Keyword-Stuffing.
- Leere Felder in der Spezifikation bedeuten, dass das entsprechende Element
  entfällt. Ergänze keine Eyebrows, sekundären CTAs, Abschnitts-CTAs, Banner oder
  Karten nur deshalb, weil dafür ein Feld im gelieferten Datenmodell existiert.
